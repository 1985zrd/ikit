...
<template>
  <ik-menu>
    <ik-menu-item>菜单项</ik-menu-item>
    <ik-sub-menu title="子菜单">
      <ik-menu-item>子菜单项</ik-menu-item>
    </ik-sub-menu>
  </ik-menu>
</template>
```
...
#|inlineCollapsedAttrName|自带收缩按钮动态切换模式按钮|string||
|showInlineCollapsedTwoLine|缩起时icon和内容两行展示题颜色|boolean
