...
<template>
  <div class="icons-list">
    <ik-icon type="setting" theme="filled" />
    <ik-icon type="home" />
    <ik-icon type="smile" theme="outlined" />
    <ik-icon type="sync" spin />
    <ik-icon type="smile" :rotate="180" />
    <ik-icon type="loading" />
  </div>
</template>
<style scoped>
  .icons-list >>> .anticon {
...
export const ikangIcon = `
<template>
  <div class="icons-list">
    <ik-icon type="iconupload" isIk/>
    <ik-icon type="icontime" isIk/>
    <ik-icon type="icondelete" isIk/>
    <ik-icon type="iconlink" isIk/>
    <ik-icon type="icontime" isIk/>
  </div>
</template>
<style scoped>
...
<template>
  <div class="icons-list">
    <ik-icon type="smile" theme="twoTone" />
    <ik-icon type="heart" theme="twoTone" twoToneColor="#eb2f96" />
    <ik-icon type="check-circle" theme="twoTone" twoToneColor="#52c41a" />
  </div>
</template>
<style scoped>
  .icons-list >>> .anticon {
