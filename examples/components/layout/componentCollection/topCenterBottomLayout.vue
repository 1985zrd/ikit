<template>
  <codeBox title="上中下布局" :description="description" :code="topCenterBottomLayoutCode">
    <ik-layout id="components-layout-demo-top" class="layout">
      <ik-layout-header>
        <div class="logo" />
        <ik-menu theme="dark" mode="horizontal" :defaultSelectedKeys="['2']" :style="{ lineHeight: '64px' }">
      ...
      <ik-layout-footer style="text-align: center">Design</ik-layout-footer>
    </ik-layout>
  </codeBox>
</template>

<script>
import { topCenterBottomLayoutCode } from './../codeExample'
export default {
  data () {
    return {
      topCenterBottomLayoutCode,
