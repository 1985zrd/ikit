<template>
  <div class="content">
    <codeBox :title="title"
             ...
             :code="topOfNavigation">
      <div>
        <ik-menu v-model="current"
                 mode="horizontal"
                 theme='dark'>
          <ik-menu-item key="mail">
            <ik-icon type="icontime"
                     isIk />Navigation One
          </ik-menu-item>
          <ik-menu-item key="app"
                        disabled>
            <ik-icon type="icontime"
                     isIk />Navigation Two
          </ik-menu-item>
...
<script>
import { topOfNavigation } from './../codeExample'
